...
function EditarAdm() {
    ...
    useEffect(() => {
        const carregarPerfil = async () => {
            ...
            } else setErroPerfil('Administrador não encontrado.');
            setCarregandoPerfil(false);
        };
        carregarPerfil();
    }, [id]);
        ...
        <div className="min-h-screen bg-gray-100">
            ...
            <main className="flex items-center justify-center py-12 px-4">
                <div className="bg-white rounded-3xl shadow-xl p-12 w-full max-w-2xl">
                    <h1 className="text-center text-4xl font-bold text-[#004d9d] mb-8 font-lobster">Editar Administrador</h1>
