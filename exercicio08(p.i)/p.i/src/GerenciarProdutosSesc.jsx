...
function GerenciarProdutos() {
  ...
  const handleAdicionarProdutosSesc = () => {
    navigate('/AdicionarProdutosSesc');
  };
  ...
  <header className="bg-[#004d9d] text-white app-header">
      ...
      <main className="px-8 py-12">
        <div className="max-w-6xl mx-auto">
          ...
          <h1 className="text-center text-5xl font-bold text-[#004d9d] mb-8 font-lobster">Sesc</h1>

          {/* Botão Adicionar Produto */}
          <div className="flex justify-center mb-8">
            <button
              onClick={handleAdicionarProdutosSesc}
